...
var parsed, // nopt parsed result
    ...
    AP = Array.prototype, // array prototype
...
optlist = cli.optlist = {
    ...
    configfile: {
        info: 'Specify an alternate configfile. By default, nengine looks in the current or parent directories for the nearest nengine.json.',
        type: path
    },
    debug: {
        short: 'd',
    ...
    if (options) {
        ...
        Object.keys(options).forEach(function (key){
            if (!(key in cli.options)) {
                ...
                AP.push.apply(cli.options[key], options[key]);
            }
        });
    }
